package OSM::API::Mapnik::Schema::Result::PlanetOsmLine;
...
OSM::API::Mapnik::Schema::Result::PlanetOsmLine

=cut

__PACKAGE__->table("planet_osm_line");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6wygW5kFbAH57qPPChCLWA
