package OSM::API::Mapnik::Schema::Result::PlanetOsmPoint;
...
OSM::API::Mapnik::Schema::Result::PlanetOsmPoint

=cut

__PACKAGE__->table("planet_osm_point");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mmeiyaauygjPnrnezKVgmA
