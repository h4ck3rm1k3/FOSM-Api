package OSM::API::Mapnik::Schema::Result::PlanetOsmRoad;
...
OSM::API::Mapnik::Schema::Result::PlanetOsmRoad

=cut

__PACKAGE__->table("planet_osm_roads");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:g+UIt70xPIyr/N5IYaQuNQ
