package OSM::API::OSMRailsPort::Schema::Result::CurrentNodeTag;
...
__PACKAGE__->table("current_node_tags");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4ASo+BX4t2Mg3d9i4B0ZyA
