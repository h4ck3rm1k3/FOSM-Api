package OSM::API::OSMRailsPort::Schema::Result::CurrentRelationTag;
...
__PACKAGE__->table("current_relation_tags");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HvUHLvpScXW449JJWgUDoQ
